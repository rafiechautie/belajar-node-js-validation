...
describe('Joi', function () {
    ...
    it('should can validate basic data type', function () {
        ...
        console.info(resultUsername, "result username");

        const resultIsAdmin = isAdminSchema.validate("true");
        console.info(resultIsAdmin, "result is admin");

        console.info(typeof "true");
        console.info(typeof resultIsAdmin.value, "ini type of value");
        console.info(typeof resultIsAdmin.error, "ini type of error");
